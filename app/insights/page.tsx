...
const articles = [
  ...
  },
  {
    ...
    excerpt: 'A comprehensive guide to creating decentralized applications that can handle millions of users.',
    category: 'Web3',
    author: {
      name: 'Sarah Johnson',
  ...
  },
  {
    ...
    excerpt: 'Learn the key principles and patterns for building robust microservices architectures.',
  ...
  },
  {
    ...
    excerpt: 'Why PWAs are becoming the preferred choice for modern web applications.',
    category: 'Technology',
    author: {
      name: 'Alex Chen',
      avatar: 'https://i.pravatar.cc/150?img=12',
  ...
  },
  {
    ...
    excerpt: 'How businesses can leverage technology to transform their operations and customer experience.',
    category: 'Business',
    author: {
      name: 'Sarah Johnson',
      avatar: 'https://i.pravatar.cc/150?img=48',
